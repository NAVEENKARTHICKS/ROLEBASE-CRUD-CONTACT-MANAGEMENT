...
export default function Signup() {
    ...
    const handlesubmit = async (event) => {
        ...
        else if (descript === '' || descript === null) {
                                    ...
                                    <div width="100%" className="table table-bordered up">
                                        ...
                                        <div>
                                            ...
                                            <div className='text-center'>
                                                ...
                                                <div>
                                                    <input type="text" name="location" id="location" placeholder='Enter Location' className="form-control" />
                                                </div>
                                            </div>
                                            <div className='text-center'>
                                                <label className='text-light'>Description : </label>
                                                <div>
                                                    <input type="text" name="descript" id="descript" placeholder='Enter Description' className="form-control" />
                                                </div>
                                            </div>
                                            <div className='text-center'>
